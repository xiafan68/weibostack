...
public class Tweet implements UncertainObject, Comparable<Tweet> {
	...
	public Tweet(String mid, String content, String uname, String uid, long ts, String oMid) {
		super();
		this.mid = mid;
	...
	public String toString() {
		return mid + SEPERATOR + NormFormat.escape(content) + SEPERATOR + NormFormat.escape(uname) + SEPERATOR + uid
				+ SEPERATOR + ts + SEPERATOR + oMid + SEPERATOR + certain;
	}
	...
	public void parse(Status status) {
		this.mid = Long.toString(status.getId());
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		DirLineReader reader = new DirLineReader("/Users/xiafan/Documents/dataset/expr/twitter/orgin/part0.txt");
		String line = null;

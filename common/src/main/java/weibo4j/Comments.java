...
public class Comments {
	 ...
	 * @since JDK 1.5
	 */
	public CommentWapper getCommentById(String id) throws WeiboException, weibo4j.WeiboException {
	...
	public CommentWapper getCommentById(String id, Paging page,
			Integer filter_by_author) throws WeiboException, weibo4j.WeiboException {
		return Comment.constructWapperComments(Weibo.client.get(
				WeiboConfig.getValue("baseURL") + "comments/show.json",
				new PostParameter[] {
	 ...
	 * @since JDK 1.5
	 */
	public CommentWapper getCommentByMe() throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public CommentWapper getCommentToMe() throws WeiboException, weibo4j.WeiboException {
		return Comment.constructWapperComments(Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public CommentWapper getCommentTimeline() throws WeiboException, weibo4j.WeiboException {
		return Comment.constructWapperComments(Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public CommentWapper getCommentTimeline(Paging page) throws WeiboException, weibo4j.WeiboException {
		return Comment.constructWapperComments(Weibo.client.get(
	 ...
	 * @since JDK 1.5
	 */
	public CommentWapper getCommentMentions() throws WeiboException, weibo4j.WeiboException {
		return Comment.constructWapperComments(Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray getCommentShowBatch(String cids) throws WeiboException, weibo4j.WeiboException {
	 ...
	 */
	public Comment replyComment(String cid, String id, String comment,
			Integer without_mention, Integer comment_ori) throws WeiboException, weibo4j.WeiboException {
		return new Comment(
				Weibo.client.post(
	 ...
	 * @since JDK 1.5
	 */
	public Comment destroyComment(String cid) throws WeiboException, weibo4j.WeiboException {
		return new Comment(Weibo.client.post(WeiboConfig.getValue("baseURL")
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray destoryCommentBatch(String cids) throws WeiboException, weibo4j.WeiboException {

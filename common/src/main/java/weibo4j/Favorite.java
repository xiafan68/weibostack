...
public class Favorite {
	 ...
	 * @since JDK 1.5
	 */
	public List<Favorites> getFavorites() throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public List<Favorites> getFavorites(Paging page) throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getFavoritesIds() throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getFavoritesIds(Paging page) throws WeiboException, weibo4j.WeiboException {
		return Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public Favorites showFavorites(String id) throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public List<Favorites> getFavoritesByTags(String tid) throws WeiboException, weibo4j.WeiboException {
		return Favorites.constructFavorites(Weibo.client.get(
	 ...
	 * @since JDK 1.5
	 */
	public List<FavoritesTag> getFavoritesTags() throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public Favorites createFavorites(String id) throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public Favorites destroyFavorites(String id) throws WeiboException, weibo4j.WeiboException {
		return new Favorites(Weibo.client.post(WeiboConfig.getValue("baseURL")
	 ...
	 * @since JDK 1.5
	 */
	public Boolean destroyFavoritesBatch(String ids) throws WeiboException, weibo4j.WeiboException {
		try {
			return Weibo.client
	 ...
	 * @since JDK 1.5
	 */
	public Favorites updateFavoritesTags(String id) throws WeiboException, weibo4j.WeiboException {
		return new Favorites(Weibo.client.post(WeiboConfig.getValue("baseURL")
	 ...
	 * @since JDK 1.5
	 */
	public Boolean destroyFavoritesTagsBatch(String ids) throws WeiboException, weibo4j.WeiboException {
		try {
			return Weibo.client
					.post(WeiboConfig.getValue("baseURL")
							+ "favorites/destroy_batch.json",

...
public class Timeline {
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getPublicTimeline() throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getPublicTimeline(int count, int baseApp) throws WeiboException, weibo4j.WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getFriendsTimeline() throws weibo4j.WeiboException, WeiboException {
	...
	public StatusWapper getFriendsTimeline(Integer baseAPP, Integer feature,
			Paging paging) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getFriendsTimelineIds() throws weibo4j.WeiboException, WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getHomeTimeline() throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getUserTimeline() throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json"));
	}
	public StatusWapper getUserTimelineByUid(String uid) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json",new PostParameter[]{
			new PostParameter("uid", uid)
		}));
	}
	public StatusWapper getUserTimelineByName(String screen_name) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json",new PostParameter[]{
	...
	public StatusWapper getUserTimelineByUid(String uid, Paging page,
			Integer base_app, Integer feature) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
	...
	public StatusWapper getUserTimelineByName(String screen_name, Paging page,Integer base_app, Integer feature) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
						WeiboConfig.getValue("baseURL")	+ "statuses/user_timeline.json",
						new PostParameter[] {
								new PostParameter("screen_name", screen_name),
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getUserTimelineIdsByUid(String uid) throws weibo4j.WeiboException, WeiboException{
		return Weibo.client.get(WeiboConfig.getValue("baseURL")+"statuses/user_timeline/ids.json",new PostParameter[]{
			new PostParameter("uid", uid)
		}).asJSONObject();
	}
	public JSONObject getUserTimelineIdsByName(String screen_name) throws weibo4j.WeiboException, WeiboException{
		return Weibo.client.get(WeiboConfig.getValue("baseURL")+"statuses/user_timeline/ids.json",new PostParameter[]{
			new PostParameter("screen_name", screen_name)
		}).asJSONObject();
	}
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getRepostTimeline(String id) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
	...
	public StatusWapper getRepostTimeline(String id, Paging page)
			throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
				WeiboConfig.getValue("baseURL")
						+ "statuses/repost_timeline.json",
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getRepostTimelineIds(String id) throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getRepostByMe() throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getRepostByMe(Paging page) throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getMentions() throws weibo4j.WeiboException, WeiboException {
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getMentionsIds() throws weibo4j.WeiboException, WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getBilateralTimeline() throws weibo4j.WeiboException, WeiboException{
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig.getValue("baseURL")+"statuses/bilateral_timeline.json"));
	}
	public StatusWapper getBilateralTimeline(Integer base_app,Integer feature) throws weibo4j.WeiboException, WeiboException{
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig.getValue("baseURL")+"statuses/bilateral_timeline.json",
				new PostParameter[]{
	 ...
	 * @since JDK 1.5
	 */
	public Status showStatus(String id) throws weibo4j.WeiboException, WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject QueryMid(Integer type, String id) throws weibo4j.WeiboException, WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject QueryMid(Integer type, String id,int is_batch) throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/querymid.json",
				new PostParameter[] { new PostParameter("id", id),
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject QueryId(String mid, Integer type,int isBase62) throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject QueryId(String mid, Integer type, Integer isBatch,Integer isBase62) throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(
				WeiboConfig.getValue("baseURL") + "statuses/queryid.json",
				new PostParameter[] { new PostParameter("mid", mid),
						new PostParameter("type", type.toString()),
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray getRepostDaily() throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray getRepostWeekly() throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray getCommentsDaily() throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray getCommentsWeekly() throws weibo4j.WeiboException, WeiboException {
		return Weibo.client.get(WeiboConfig
	 ...
	 * @since JDK 1.5
	 */
	public Status Repost(String id) throws weibo4j.WeiboException, WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public Status Destroy(String id) throws weibo4j.WeiboException, WeiboException {
		return new Status(Weibo.client.post(WeiboConfig.getValue("baseURL")
	 ...
	 * @since JDK 1.5
	 */
	public Status UpdateStatus(String status) throws weibo4j.WeiboException, WeiboException {
		return new Status(Weibo.client.post(WeiboConfig.getValue("baseURL")
	...
	public Status UpdateStatus(String status, Float lat, Float longs,
			String annotations) throws weibo4j.WeiboException, WeiboException {
		return new Status(Weibo.client.post(WeiboConfig.getValue("baseURL")
	...
	public Status UploadStatus(String status, ImageItem item, Float lat,
			Float longs) throws weibo4j.WeiboException, WeiboException {
		return new Status(Weibo.client.multPartURL(
				WeiboConfig.getValue("baseURL") + "statuses/upload.json",
				new PostParameter[] { new PostParameter("status", status),
						new PostParameter("lat", lat.toString()),
	 ...
	 * @since JDK 1.5
	 */
	public List<Emotion> getEmotions() throws weibo4j.WeiboException, WeiboException {

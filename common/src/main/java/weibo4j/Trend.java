...
public class Trend {
	 ...
	 * @since JDK 1.5
	 */
	public List<Trends> getTrendsDaily(String uid,Integer cid,Integer pid) throws WeiboException {
		return Trends.constructTrendsList(Weibo.client.get(
				WeiboConfig.getValue("baseURL") + "trends/hot_sp.json",new PostParameter[] { new PostParameter("uid", uid),new PostParameter("pid", pid),new PostParameter("cid", cid) }));
	}

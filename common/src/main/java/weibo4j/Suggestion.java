...
//---------------------------------推荐接口---------------------------------------------------
	 ...
	 * @since JDK 1.5
	 */
	public UserWapper suggestionsUsersByStatus(String content) throws WeiboException, weibo4j.WeiboException{
	...
	public UserWapper suggestionsUsersByStatus(String content,int num) throws WeiboException, weibo4j.WeiboException{
		return User.constructWapperUsers(Weibo.client.get(WeiboConfig.getValue("baseURL")+"suggestions/users/by_status.json",new PostParameter[]{
			new PostParameter("content", content),
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper suggestionsStatusesHot(int type,int isPic) throws WeiboException, weibo4j.WeiboException{
	...
	public StatusWapper suggestionsStatusesHot(int type,int isPic,Paging page) throws WeiboException, weibo4j.WeiboException{
		return Status.constructWapperStatus(Weibo.client.get(WeiboConfig.getValue("baseURL")+"suggestions/statuses/hot.json",new PostParameter[]{
			new PostParameter("type", type),
			new PostParameter("is_pic", isPic)
		},page));
	 ...
	 * @since JDK 1.5
	 */
	public JSONArray suggestionsFavoritesHot() throws WeiboException, weibo4j.WeiboException{
		return Weibo.client.get(WeiboConfig.getValue("baseURL")+"suggestions/favorites/hot.json").asJSONArray();
	}
	public JSONArray suggestionsFavoritesHot(int page,int count) throws WeiboException, weibo4j.WeiboException{
	 ...
	 * @since JDK 1.5
	 */
	public User suggestionsUsersNot_interested(String uid) throws WeiboException, weibo4j.WeiboException{
